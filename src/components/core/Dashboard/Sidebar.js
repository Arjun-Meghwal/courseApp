...
return (
  ...
  >
    ...
    <div className="md:mt-auto">
      ...
      <div className="mx-auto my-4 md:my-6 h-[1px] w-10/12 bg-richblack-600"></div>
    ...
    {confirmationModal && (
      <div className="fixed inset-0 z-50 grid place-items-center bg-black/60 p-4">
        <div className="w-full max-w-[400px] border rounded-lg bg-richblack-900 p-6 text-white">

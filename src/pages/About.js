...
return (
  <div className="bg-gradient-to-b from-[#020617] via-[#0f172a] to-[#020617] text-white overflow-x-hidden">
    ...
    {/* HERO */}
    <section className="mx-auto max-w-maxContent px-4 py-12 sm:py-16 md:py-20 text-center">
    ...
    <section className="flex flex-col md:flex-row gap-6 justify-center px-4">
      <img
        ...
        alt="Learning online"
        className="rounded-xl object-cover h-[220px] md:h-auto w-full md:w-[30%] shadow-lg hover:scale-105 transition duration-300"
      />
      <img
    ...
    <section className="mx-auto max-w-maxContent px-4 py-20 grid md:grid-cols-2 gap-10 items-center">
      ...
      <img
        ...
        alt="Team discussion"
        className="w-full rounded-xl shadow-[0_0_40px_rgba(255,100,100,0.2)] hover:scale-105 transition duration-300"
      />
    </section>

    {/* VISION + MISSION */}
    <section className="mx-auto max-w-maxContent px-4 py-16 md:py-20 grid md:grid-cols-2 gap-8 md:gap-16">
    ...
    {/* STATS */}
    <section className="bg-richblack-800 py-10 md:py-14">
      <div className="mx-auto max-w-maxContent px-4 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
        {stats.map((stat, index) => (
          <div key={index} className="hover:scale-105 transition">
            <h3 className="text-2xl md:text-3xl font-bold text-richblack-5">
              {stat.value}
            </h3>
    ...
    <section className="mx-auto max-w-maxContent px-4 py-20 grid md:grid-cols-2 gap-10 items-center">
      <div>
        ...
        <button className="w-full sm:w-auto bg-yellow-400 text-black px-6 py-3 rounded-md font-semibold hover:scale-105 transition">
          Learn More
        </button>
      </div>
    ...
    <section className="mx-auto max-w-maxContent px-4 py-20">
      ...
      <form className="max-w-xl mx-auto space-y-4 bg-white/5 p-4 sm:p-6 rounded-xl backdrop-blur-lg border border-white/10">

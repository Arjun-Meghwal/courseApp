...
return (
  <div
    ...
    px-4 sm:px-6 text-white overflow-x-hidden"
  >
    ...
    {loading ? (
      ...
      <div
        ...
        p-5 sm:p-6 md:p-8 space-y-5 sm:space-y-6"
      >
        ...
        <p className="text-sm text-richblack-300 text-center leading-relaxed break-words">
          {!emailSent

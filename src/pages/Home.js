...
return (
  <div className="bg-gradient-to-b from-[#020617] via-[#0f172a] to-[#020617] text-white overflow-x-hidden">
    ...
    <div
      className="relative mx-auto flex flex-col max-w-maxContent
      items-center justify-center min-h-[80vh]
      gap-5 sm:gap-6 text-center px-4"
    >
      ...
      <Link to="/dashboard/my-profile">
        <div
          ...
          mt-6 sm:mt-8
          px-4 sm:px-6 py-2 text-xs sm:text-sm text-richblack-200
      ...
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mt-4 sm:mt-6">
      ...
      <p className="max-w-[600px] text-base sm:text-lg text-richblack-300 leading-relaxed">
      ...
      <div className="flex gap-4 sm:gap-6 mt-6 sm:mt-8 flex-wrap justify-center">
        <CTAButton
          active={true}
      ...
      <div className="mx-auto w-full max-w-[900px] mt-8 sm:mt-12">
        <div
  ...
  greet(); `}
    ...
    <div
      ...
      items-center gap-8 sm:gap-10 py-12 sm:py-20"
    >
      <InstructorSection />
      <ReviewsSection />
    </div>
